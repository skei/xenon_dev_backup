...
nc1 dd 128;416;208              ; Antall koordinater
np1 dd 256;832;412              ; antall polygons
include torus.inc;sjakk1.inc;x2.inc
               
Texture label byte
 include kule.db;texture.db
Palette label byte            
 include kulepal.db;palette.db
Buffer label byte
 db 64000 dup(0)
Bump Label word    
 include bumpmap.db
...
; N† burde de v‘re sortert etter Y...
 ...
 mov d [ty2],ebx      
 mov d [ty3],ecx     
 mov eax,d [BumCoords+esi]
 mov ebx,d [BumCoords+edi]
 mov ecx,d [BumCoords+ebp]
 mov d [by1],eax
 mov d [by2],ebx      
 mov d [by3],ecx     
...
RotLoop2:                 
 ...
 add bx,127 
 add cx,127 
 mov w [BumCoords+edx],cx
 mov w [BumCoords+edx+2],bx
 pop cx           
 pop bx           
