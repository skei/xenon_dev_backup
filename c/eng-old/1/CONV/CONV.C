...
void SaveFile (char *s)
{
 ...
 itemp = OBJECT_HEADER;
 fwrite(&itemp,4,1,fp);
 fwrite(&Sphere,4,1,fp);       // bounding sphere radius
 ...
 itemp = NumPolys;
 fwrite(&itemp,4,1,fp);   // Number of polys in object
...
void main( int argc, const char *argv[] )
{
 ...
 printf ("\n");
 printf ("ASC converter v0.2à Axon / Inf.Xenon\n\n");
