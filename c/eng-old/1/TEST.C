...
// ------------------------------
 ...
 if (Engine_Init(320,200,15,TRUE,10000,2) == FALSE)
 {
...
// ------------------------------
  ...
  O1 = Load3DS("thinblob.3ds",100,250);
  LoadVUE("thinblob.vue");
...
// Blob = Load3DS("thinblob.3ds",100,250);
 ...
 Blob = Load3DS("birdshow.3ds",10,250);

 printf("Camera spline: %i\n",Camera->KeyFramerPos.NumSegments);
 getch();
...
// ------------------------------
 ...
 Seg[0].TimeStamp = 0;
 Seg[0].Pos.x = 0; Seg[0].Pos.y = 0; Seg[0].Pos.z = 0;

 Seg[1].TimeStamp = 30;
 Seg[1].Pos.x = 0; Seg[1].Pos.y = 0; Seg[1].Pos.z = -300;

 Seg[2].TimeStamp = 125;
 Seg[2].Pos.x = 0; Seg[2].Pos.y = 300; Seg[2].Pos.z = 0;

 Seg[3].TimeStamp = 250;
 Seg[3].Pos.x = -300; Seg[3].Pos.y = 100; Seg[3].Pos.z = 0;

 Seg[4].TimeStamp = 400;
 Seg[4].Pos.x = 100; Seg[4].Pos.y = -200; Seg[4].Pos.z = 300;



 O1->KeyFramerPos.Flags = 0;      // ignored ???
 O1->KeyFramerPos.CurrentPos = 0;
 O1->KeyFramerPos.Speed = 2;
 O1->KeyFramerPos.CurrentSegment = 0;
 O1->KeyFramerPos.NumSegments = 5;
 O1->KeyFramerPos.BendSize = 1.0;
 O1->KeyFramerPos.SplineSegments = &Seg;

 Spline_Init( &O1->KeyFramerPos );
