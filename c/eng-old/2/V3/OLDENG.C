...
// ..........................................................................
 ...
 //  3
 {
  x2_x1 = ( X2 - X1 );
  if (x2_x1 == 0) return;
  _innerColorAdder = (C2-C1) / x2_x1;
  _innerTexAdder   = ((short int)((U2-U1)/x2_x1) << 16)
                    + (short int)((V2-V1)/x2_x1);
  _outerTexAdder   = ((short int)((U3-U1)/y3_y1) << 16)
                    + (short int)((V3-V1)/y3_y1);
  _outerColorAdder = (C3-C1)  / y3_y1;
...
// ..........................................................................
 ...
 // 2 3
 {
  x3_x2 = ( X3 - X2 );
  if (x3_x2 == 0) return;
  _innerColorAdder = (C3-C2) / x3_x2;
  _innerTexAdder   = ((short int)((U3-U2)/x3_x2) << 16)
                    + (short int)((V3-V2)/x3_x2);
  _outerTexAdder   = ((short int)((U2-U1)/y3_y1) << 16)
                    + (short int)((V2-V1)/y3_y1);
  _outerColorAdder = (C2-C1)  / y3_y1;
...
// ..........................................................................
 ...
 // 3 (4)          3
 {
  ...
  x4_x3 = ( X4 - X3 );
  if (x4_x3 == 0) return;
  _innerColorAdder = (C4-C3) / x4_x3;
  _innerTexAdder   = ((short int)((U4-U3)/x4_x3) << 16)
                    + (short int)((V4-V3)/x4_x3);
  _outerTexAdder   = ((short int)((U3-U1)/y3_y1) << 16)
                    + (short int)((V3-V1)/y3_y1);
  _outerColorAdder = (C3-C1) / y3_y1;
  _outerLeftAdder  = slope13;
  _outerRightAdder = slope12;
  GTfiller1(Y1,Y2,(X1<<16),
                  (X1<<16),
                  ((U1<<24)+(V1<<8)),
                  C1);
...
// ..........................................................................
 ...
 //(4) 3
 {
  ...
  _innerColorAdder = (C3-C4) / x3_x4;
  _innerTexAdder   = ((short int)((U3-U4)/x3_x4) << 16)
                    + (short int)((V3-V4)/x3_x4);
  _outerTexAdder   = ((short int)((U2-U1)/y2_y1) << 16)
                    + (short int)((V2-V1)/y2_y1);
  _outerColorAdder = (C2-C1) / y2_y1;
  ...
  GTfiller1(Y1,Y2,(X1<<16),
                  ...
                  ((U1<<24)+(V1<<8)),
                  C1);
  _outerTexAdder   = ((short int)((U3-U2)/y3_y2) << 16)
                    + (short int)((V3-V2)/y3_y2);
  _outerColorAdder = (C3-C2) / y3_y2;
...
//  vector = Vector_Trans3x3( vertex->Normal, &o->m);
  ...
  vertexR->c = _PhongMap[(yy*256+xx) & 0xFFFF] << 8;
  vertex++;
  vertexR++;
 }
}
...
void CalcLight_Directional(sObject *o, sGroup *g)
{
 ...
 for (i=0;i<g->NumVertices;i++)
 {
  ...
  xx = (int)vector.x + LightAdd;
  yy = (int)vector.y + LightAdd;
  o->VerticesR[n].c = _PhongMap[(yy*256+xx) & 0xFFFF] << 8;
 }
}
