...
//
 ...
 tVertex  TempVertices[12];    // array 12 of tVertex
 tVertex *ClipPoly[12];       // array 12 of pointers to tVertex
 tVertex *ClipTemp[12];       // array 12 of pointers to tVertex
...
void Poly_Tex( tPolygon *P, char *buffer )
 {
