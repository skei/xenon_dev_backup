...
var sine : array[0..16383] of integer;
...
Procedure CalcSinus(m,a,s:integer);
var x : word;
    y : real;
Begin
  y := -pi;
...
Begin
 ...
 begin
  Writeln ('MakeTable v0.1 - (c) Axon 1994...');
  ...
  Writeln ('        size = Total number of elements in array');
  Writeln ('        B/W  = B for byte/shortint, W for word/integer');
 ...
 assign (f,paramstr(1));
 rewrite (f);
 Writeln (f,'; Table created with MakeTabl v0.1 - (c) 1995 Axon');
